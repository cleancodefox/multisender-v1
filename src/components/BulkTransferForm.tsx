    ...
    <div className="border border-black bg-white p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        <button
          ...
          className={`p-6 border border-black text-left font-bold text-lg transition-colors ${
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <Input
              ...
              className="h-16 text-xl font-bold border border-black bg-white text-black focus:border-black pr-16"
            />
